...
export const REGULATIONS: Regulation[] = [
  ...
  { id: 'r61', speciesId: 'chinook', waterBodyId: 'green', seasonStart: '07-01', seasonEnd: '10-31', dailyLimit: 2, minSize: 24, hatcheryOnly: true, gearRestriction: 'Barbless hooks only', notes: 'See WDFW regulations for current season dates and restrictions', emergencyClosedFrom: '2026-08-20', emergencyClosedTo: null, emergencyRuleUrl: 'https://wdfw.wa.gov/fishing/regulations/emergency-rules/green-duwamish-river-chinook-retention-closed-2026-08', emergencyReason: 'Chinook return much smaller than forecasted. Retention CLOSED Aug 20 until further notice (Tukwila Intl Blvd to S 212th St Bridge). Upper river ALL FISHING closed Sept 16–Oct 31 (Auburn Black Diamond Road Bridge to Tacoma Municipal Boundary Marker).', emergencyLocation: 'Lower section (Tukwila Intl Blvd to S 212th St Bridge): Chinook retention closed. Upper section (Auburn Black Diamond Rd Bridge to Tacoma Municipal Boundary): all species closed Sept 16–Oct 31.' },
  ...
  // 2026 is an even year — no pink run. emergencyClosedFrom/To covers all of 2026
  // so status shows CLOSED. Remove the emergencyClosedTo in 2027 when the run is back.
  { id: 'r298', speciesId: 'pink', waterBodyId: 'skagit',      seasonStart: '08-01', seasonEnd: '09-30', dailyLimit: 6, minSize: null, hatcheryOnly: false, gearRestriction: null, emergencyClosedFrom: '2026-01-01', emergencyClosedTo: '2026-12-31', notes: 'ODD YEARS ONLY (2025, 2027, 2029...). No pink run in even years. One of the largest pink salmon runs in WA when open.' },
  { id: 'r299', speciesId: 'pink', waterBodyId: 'snohomish',   seasonStart: '08-01', seasonEnd: '09-30', dailyLimit: 6, minSize: null, hatcheryOnly: false, gearRestriction: null, emergencyClosedFrom: '2026-01-01', emergencyClosedTo: '2026-12-31', notes: 'ODD YEARS ONLY (2025, 2027, 2029...). No pink run in even years. Snohomish has one of the biggest pink runs in Puget Sound.' },
  { id: 'r300', speciesId: 'pink', waterBodyId: 'nooksack',    seasonStart: '08-01', seasonEnd: '09-30', dailyLimit: 6, minSize: null, hatcheryOnly: false, gearRestriction: null, emergencyClosedFrom: '2026-01-01', emergencyClosedTo: '2026-12-31', notes: 'ODD YEARS ONLY (2025, 2027, 2029...). No pink run in even years.' },
  { id: 'r301', speciesId: 'pink', waterBodyId: 'green',       seasonStart: '08-01', seasonEnd: '09-30', dailyLimit: 6, minSize: null, hatcheryOnly: false, gearRestriction: null, emergencyClosedFrom: '2026-01-01', emergencyClosedTo: '2026-12-31', notes: 'ODD YEARS ONLY (2025, 2027, 2029...). No pink run in even years.' },
  { id: 'r302', speciesId: 'pink', waterBodyId: 'puyallup',    seasonStart: '08-01', seasonEnd: '09-30', dailyLimit: 6, minSize: null, hatcheryOnly: false, gearRestriction: null, emergencyClosedFrom: '2026-01-01', emergencyClosedTo: '2026-12-31', notes: 'ODD YEARS ONLY (2025, 2027, 2029...). No pink run in even years.' },
