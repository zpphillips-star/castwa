...
export const REGULATIONS: Regulation[] = [
  ...
  // Sockeye Salmon
  { id: 'r6b', speciesId: 'sockeye', waterBodyId: 'skagit', seasonStart: '07-01', seasonEnd: '07-31', dailyLimit: 4, minSize: 12, hatcheryOnly: true, gearRestriction: 'Night closure in effect; 2-rod OK; SGR not required for salmon', notes: 'Open by section — see section rules. Active emergency rule through Jul 31 2026 (WDFW ER 26-114-136727). Hatchery fish only (clipped adipose fin). Release all salmon other than sockeye.' },
